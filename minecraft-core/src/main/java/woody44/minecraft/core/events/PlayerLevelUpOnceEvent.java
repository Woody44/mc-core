...
public class PlayerLevelUpOnceEvent  extends Event{
    ...
    public PlayerLevelUpOnceEvent(PlayerCore player, int previousLevel, int newLevel, int previousExp, int newExp) {
        Player = player;
